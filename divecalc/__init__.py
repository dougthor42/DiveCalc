...
A simple dive calculator based on SSI Doppler no-decompression dive tables.
...
### Constants ###############################################################
__version__ = "0.0.1.0"
__project_url__ = "https://github.com/dougthor42/DiveCalc"
__project_name__ = "DiveCalc"
__description__ = "No-decomplression dive calculator"
__long_descr__ = """/
"""
...
def _setup_logging():
    ...
    logfilename = "{}.log".format(__project_name__)
